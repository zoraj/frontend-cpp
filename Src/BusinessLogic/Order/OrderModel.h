...
struct OrderDetailModel : public QObject {
    ...
    Q_PROPERTY(float prix MEMBER prix);
...
struct OrderModel: public QObject {
    int id = Constant::UNDEFINED_INT;
    int mmcClientId;
    int numTable;
    int nbCouvert;
    ...
    QDateTime dateNote;
    QString service;
    QList<OrderDetailModel *> orderDetail;
    int activiteId;
    int userId;
    QString etat;
    ...
    Q_PROPERTY(QList<OrderDetailModel *> orderDetail MEMBER orderDetail);
